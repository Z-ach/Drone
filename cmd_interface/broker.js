...
const cfg_set_kP = 0xFFF10000;
const cfg_set_kI = 0xFFF20000;
const cfg_set_kD = 0xFFF30000;
const cfg_set_thr = 0xFFF40000;
...
function handle_cfg(cfg_url){
  ...
  if(sliced_url.startsWith('update')){
    ...
    last_cfg_resp = '';
    send_command(((cfg_set_kP | (queryObject.kP*10000))>>>0).toString(16));
    send_command(((cfg_set_kI | (queryObject.kI*10000))>>>0).toString(16));
    send_command(((cfg_set_kD | (queryObject.kD*10000))>>>0).toString(16));
